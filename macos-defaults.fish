...
if not test -e /Library/Apple/usr/lib/libRosettaAot.dylib
...
defaults write NSGlobalDomain AppleHighlightColor -string "0.984561 0.016293 0.829312"
...
# Use a modified version of the Belafonte Night theme by default in Terminal.app
echo "\
...
tell application "Terminal"
	...
	local windowID
	set themeName to "Belafonte Night"
	...
	do shell script "open '$HOME/settings/" & themeName & ".terminal'"
